              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isEnrolled && (
                      <>
                        <span className="px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 text-[10.5px] font-bold border border-emerald-200 inline-flex items-center gap-1">
                          <Check className="w-3 h-3" /> Enrolled • Lifelong Access
                        </span>
